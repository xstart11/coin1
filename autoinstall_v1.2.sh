...
COINDOWNLOADLINK1=https://github.com/DaralCoin/Daral/releases/download/v1.2/darald
COINDOWNLOADLINK2=https://github.com/DaralCoin/Daral/releases/download/v1.2/daral-cli
COINDOWNLOADLINK3=https://github.com/DaralCoin/Daral/releases/download/v1.2/daral-tx
COINPORT=4361
COINRPCPORT=8938
COINDAEMON=darald
COINDAEMONCLI=daral-cli
COINDAEMONTX=daral-tx
COINCORE=.daral
COINCONFIG=daral.conf
...
echo -e "------------------------------------------------------------"
echo -e "|                                                          |"
echo -e "|        ${BOLD}---- Daral masternode installer ----${NONE}        |"
echo -e "|                                                          |"
echo -e "------------------------------------------------------------"

echo -e "${BOLD}"
read -p "This script will install a Daral masternode wallet on your VPS. Do you wish to continue? (y/n)?" response
echo -e "${NONE}"
