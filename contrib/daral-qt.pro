...
RESOURCES += src/qt/daral.qrc src/qt/daral_locale.qrc

TRANSLATIONS += src/qt/locale/daral_bg.ts \
                src/qt/locale/daral_de.ts \
                src/qt/locale/daral_en.ts \
                src/qt/locale/daral_es.ts \
                src/qt/locale/daral_fi.ts \
                src/qt/locale/daral_fr.ts \
                src/qt/locale/daral_it.ts \
                src/qt/locale/daral_ja.ts \
                src/qt/locale/daral_pl.ts \
                src/qt/locale/daral_pt.ts \
                src/qt/locale/daral_ru.ts \
                src/qt/locale/daral_sk.ts \
                src/qt/locale/daral_sv.ts \
                src/qt/locale/daral_vi.ts \
                src/qt/locale/daral_zh_CN.ts \
                src/qt/locale/daral_zh_TW.ts
