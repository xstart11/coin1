...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DRL features */
        {"daral", "masternode", &masternode, true, true, false},
        {"daral", "masternodelist", &masternodelist, true, true, false},
        {"daral", "mnbudget", &mnbudget, true, true, false},
        {"daral", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"daral", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"daral", "mnsync", &mnsync, true, true, false},
        {"daral", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"daral", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use darald, or the -server option to daral-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Daral Alert\" admin@foo.com\n"),
...
{
    return "> daral-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8792/\n";
}
