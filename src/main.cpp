...
#if defined(NDEBUG)
#error "Daral cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Daral Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if( nHeight > 1 && nHeight <= 6000 ) {
	        nSubsidy = 1 * COIN;
	}else if( nHeight > 6000 && nHeight <= 13000 ) {
	        nSubsidy = 20 * COIN;
	}else if( nHeight > 13000 && nHeight <= 18000 ) {
	        nSubsidy = 25 * COIN;
	}else if( nHeight > 18000 && nHeight <= 50000 ) {
	        nSubsidy = 30 * COIN;
	} else {
		nSubsidy = 20 * COIN;
	}
