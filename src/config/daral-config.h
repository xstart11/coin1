/* src/config/daral-config.h.  Generated from daral-config.h.in by configure.  */
/* src/config/daral-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://daral.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Daral Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Daral Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "daral"
