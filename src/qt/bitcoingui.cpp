                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Daral-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Daral address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and daral: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Daral Core"), this);
    aboutAction->setStatusTip(tr("Show information about Daral Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Daral"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Daral addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Daral addresses"));
    ...
    openAction->setStatusTip(tr("Open a Daral: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Daral Core help message to get a list with possible Daral command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Daral Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Daral network", "", count));
}
...
{
    QString strTitle = tr("Daral Core"); // default title
